        ...
        content: {
            ...
            content: [
                ...
                { elem: 'p', content: 'JavaScript-реализация блока i-bem — это фреймворк для работы со страницей в БЭМ-терминах. Фреймворк позволяет декларативно описывать поведение каждого блока и предоставляет хелперы для разработки.' },
                {
                    ...
                    content: [
                        { elem: 'opener', content: 'видео' },
                        { elem: 'content', content: '<object width="450" height="254"><param name="video" value="http://static.video.yandex.ru/lite/toivonens/kpd971u3cy.3127/"/><param name="allowFullScreen" value="true"/><param name="scale" value="noscale"/><embed src="http://static.video.yandex.ru/lite/toivonens/kpd971u3cy.3127/" type="application/x-shockwave-flash" width="450" height="254" allowFullScreen="true" scale="noscale"/></object>' }
                    ]
                }
            ]
        }
